...
class TestPublishTools:
    ...
    def test_get_texure_assignement_yaml_file(self):
        ...
        publish_tools = PublishTools(ROOT_PROJECT, CONTEXT, ASSET_NAME, TASK, EXTENSION)
        file = publish_tools.get_texture_assignement_yaml_file(location)
        assert file == "/Users/christophedupin/Documents/projects/repos/testSuperprod/code_test_a_cdupin/project/Assets/myAssetB/surfacing/work/texture_assignment.yaml"

    def test_get_use_textures_from_yaml(self):
        publish_tools = PublishTools(ROOT_PROJECT, CONTEXT, ASSET_NAME, TASK, EXTENSION)
