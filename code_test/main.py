...
class PublishTools:
    def publish_texture(self):
        ...
        asset_publish_directory = files_manager.get_file_directory_from_asset(files_manager.publish)
        ...
        info_from_yaml_work_file = yaml_manager.get_info_from_yaml(yaml_work_file)
        # Keep only short name of the textures files
        only_files_name = files_manager.get_only_files_name(info_from_yaml_work_file)
